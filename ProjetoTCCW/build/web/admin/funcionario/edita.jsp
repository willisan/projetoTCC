 ...
 <div class="container-fluid">
    ...
    <div class="container-fluid mt--7">
      ...
      <div class="row">
        ...
        <h5 class="title">Editar Informações do Funcionário</h5>
        ...
        <form action="UploadWS" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="urldestino" value="FuncionarioWS">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-5 pr-md-1">
                    <div class="form-group">
                        <label>Função</label>
                        <input type="text" name="txtFuncao" required class="form-control" placeholder="Função" >
                    </div>
                </div>
            </div>
            <div class="row">
